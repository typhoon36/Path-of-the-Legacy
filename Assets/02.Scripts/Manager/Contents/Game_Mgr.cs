...
public class Game_Mgr
{
    ...
    public void StopPlayer()
    {
        ...
        Player_Ctrl player = _player.GetComponent<Player_Ctrl>();
    ...
    public void OnDead()
    {
        if (_player.GetComponent<Player_Ctrl>().State != Define.State.Die)
        {
            _player.GetComponent<Player_Ctrl>().State = Define.State.Die;
    ...
    {
        _player.GetComponent<Player_Ctrl>().State = Define.State.Idle;
    ...
    {
        Base_Ctrl bc = go.GetComponent<Base_Ctrl>();
        if (bc.IsNull() == true)
