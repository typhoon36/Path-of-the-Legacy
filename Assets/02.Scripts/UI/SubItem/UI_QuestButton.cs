...
public class UI_QuestButton : UI_Base
{
    ...
    public override bool Init()
    {
        ...
        {
            Managers.Game.m_PlayScene.Quest.OnQuest(_quest);
        });
     ...
     void OnClickSceneNoticeButton()
    {
        ...
        // 알람 활성화/비활성화
        if (isNotice == true)
            isNotice = Managers.Game.m_PlayScene.Quest.SetQuestNotice(_quest);
        else
            Managers.Game.m_PlayScene.Quest.CloseQuestNotice(_quest);
