...
namespace Assets.CaptainCatSparrow.ArmorAndJewelry.Demo
{
    ...
    {
        [SerializeField]
         Sprite[] belts, body, boots, bracers, earrings, gloves, helmets, necklace, pants, rings, shoulders;
        [SerializeField]
         GameObject iconPrefab;

         Button _previousButton, _nextButton;
         ScrollRect _scroll;
         TextMeshProUGUI _label;
         Transform _helmet, _necklace, _earrings1, _earrings2, _shoulders1, _shoulders2, _bracers1, _bracers2, _belt, _gloves1, _gloves2, _pants, _boots, _ring1, _ring2;
         ArmorJewelry _selectedArmorJewelry;
        ...
        public void ValidateAndApplyDrop(GameObject dragGO, GameObject dropGO)
        {
         ...
         void StretchIcon(RectTransform rt)
        {
         ...
         void DestroyChildren(Transform parent)
        {
         ...
         void MoveArmorJewelry(int step)
        {
         ...
         void PopulateGrid(Sprite[] sprites, Color color)
        {
