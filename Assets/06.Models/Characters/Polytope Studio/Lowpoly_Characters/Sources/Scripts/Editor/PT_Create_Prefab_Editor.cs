...
namespace Polytope
{
    ...
    {
         PT_Create_Prefab script = null;

        // Meshes
         SerializedProperty meshes = null;
         SerializedProperty loaded = null;
         SerializedProperty material = null;
         SerializedProperty preview = null;
         SerializedProperty time = null;
         SerializedProperty duplicateMaterial = null;
         ...
         void Preview()
        {
         ...
         void ShaderProperty_C(string name, string label)
        {
         ...
         void ShaderProperty_CI(string name, string label)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
         ...
         void ShaderProperty_CS(string name, string label)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
         ...
         void ShaderProperty_CSM(string name, string label)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            string shaderSmoothness = "_" + name.ToUpper() + "SMOOTHNESS";
         ...
         void ShaderProperty_CSP(string name, string label)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
         ...
         void ShaderDropDownSelection()
        {
         ...
         bool IsMaterialProperty(string name)
        {
            try
            {
         ...
         void SetMaterialProperty(string name, float value)
        {
         ...
         void SetMaterialProperty(string name, Color color)
        {
            for (int i = 0; i < meshes.arraySize; i++)
            {
                SerializedProperty typeOfMeshes = meshes.GetArrayElementAtIndex(i);
         ...
         void SetMaterialProperty(string name, Texture texture)
        {
            for (int i = 0; i < meshes.arraySize; i++)
            {
                SerializedProperty typeOfMeshes = meshes.GetArrayElementAtIndex(i);
         ...
         void GetDefaultProperty_C(string name)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
         ...
         void GetDefaultProperty_CI(string name)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            string shaderTex = "_" + name.ToUpper() + "MASK";
            Material dftmat = material.FindPropertyRelative("assets").GetArrayElementAtIndex(material.FindPropertyRelative("index").intValue).objectReferenceValue as Material;
         ...
         void GetDefaultProperty_CS(string name)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            string shaderSmoothness = "_" + name.ToUpper() + "SMOOTHNESS";
            Material dftmat = material.FindPropertyRelative("assets").GetArrayElementAtIndex(material.FindPropertyRelative("index").intValue).objectReferenceValue as Material;
         ...
         void GetDefaultPorperty_CSM(string name)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            string shaderSmoothness = "_" + name.ToUpper() + "SMOOTHNESS";
            string shaderMetallic = "_" + name.ToUpper() + "METALLIC";
         ...
         void GetDefaultProperty_CSP(string name)
        {
            string shaderColor = "_" + name.ToUpper() + "COLOR";
            string shaderSize = "_" + name.ToUpper() + "SIZE";
            string shaderPower = "_" + name.ToUpper() + "POWER";
         ...
         void GetDefaultProperty_UTL()
        {
         ...
         void DefaultMaterialProperties()
        {
        ...
        public void ExpansionDragAndDrop()
        {
         ...
         void MeshesUpdateSpecials(string typeOfMeshes)
        {
        ...
        public void MeshesRandom()
        {
         ...
         void MeshesEnableRandom(string type)
        {
         ...
         bool MeshesCheckForBeard()
        {
            SerializedProperty beard = MeshesGetType(PT_Create_Prefab.TypeOfMesh.beard);
            return beard.FindPropertyRelative("list").arraySize > 0;
        }

         SerializedProperty MeshesGetType(string typeOfMeshes)
        {
            for (int i = 0; i < meshes.arraySize; i++)
            {
        ...
        public override void OnInspectorGUI()
        {
         ...
         T[] GetAssetsAtPath<T>(string path)
        {
